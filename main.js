...
const { P, C, fmt, AVAILABILITY } = require('./src/props')
...
class PxwInstance extends InstanceBase {
  ...
  getConfigFields () {
    return [
      { type: 'static-text', id: 'info', width: 12, label: 'Camera Remote Control',
        value: 'Requires <b>[Network] &gt; [Wired LAN] &gt; [Camera Remote Control] = Enable</b> on the camera, and a user name / password set under <b>[Network] &gt; [Network Setup] &gt; [Edit Authentication]</b>.' },
      { type: 'textinput', id: 'host', label: 'Camera IP address', width: 6, regex: Regex.IP },
      { type: 'textinput', id: 'user', label: 'User name', width: 6, default: 'admin' },
      { type: 'textinput', id: 'pass', label: 'Password', width: 6 },
      { type: 'number', id: 'poll', label: 'Poll interval (ms)', width: 6, default: 1000, min: 250, max: 10000 },
    ]
  }
